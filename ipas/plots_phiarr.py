...
class Make_Plots():
    ...
    def __init__(self, phio, widtharr, lengtharr, chreq, chphi, chphi2D, ch_ovrlp, ch_S, ovrlp, S, 
        ...
        self.poserr_dd = np.array(poserr_dd)
        self.negerr_dd = np.array(negerr_dd)
        ...
        self.min_dd = np.array(min_dd)
        self.max_dd = np.array(max_dd)
